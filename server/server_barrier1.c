/**
 * @file server_barrier1.c
 * @brief Barrier server instance 1 for quantum processing board communication
 *
 ...
 *
 * This server listens on IP 127.0.0.1, Port 5001.
 */
...
int main(int argc, char *argv[])
{
    ...
    while (1)
    {
        ...
        case 1:
            ...
            // send result
            FILE *result;
            result = fopen("../data/result1.txt", "r");
            if (result == NULL)
            {
        ...
        case 2:
            ...
            memset(buffer, 0, BUFFER_SIZE);
            send(new_socket, send_message, strlen(send_message), 0);
            // Receive arry_counts and qubit data
            ...
            FILE *fp;
            char filename[50];
            sprintf(filename, "../data/server_barrier_result1.txt");
